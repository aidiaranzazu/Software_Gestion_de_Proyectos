...
export const resolvers = {
    Query: {
        ...
        async ProyectoLider(_, { docLider,documento}, context) {
            // if (context.user.auth) 
            console.log(docLider);
            const lider = await Usuario.findOne({
                documento   
        ...
        async UsuarioEstudiante(_, { rol}, context) {
            // if (context.user.auth) {
            console.log
             const lider = await Usuario.findOne({
                 rol
        ...
        async GestionAvancesLider(_,{idProyecto,documentoEstudiante,documento}, context) {
            ...
            console.log(lider);
            if(lider && lider.rol ==="Lider"){        
                return GestionAvance.find({documentoEstudiante});
            // } else {
            //     return null
            // }
            }
